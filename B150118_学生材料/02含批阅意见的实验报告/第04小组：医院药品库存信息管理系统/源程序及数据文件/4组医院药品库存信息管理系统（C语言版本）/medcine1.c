...
void baseManage(Medcine med[],int n)          /*该函数完成学生成绩管理功能*/
{  
	int choice;
	do
	{
		...
		switch(choice)
		{
			case 1:   readMed(med,n);         /*求所有学生的总分*/
			          break;
			case 2:   readMed(med,n);         /*根据所有学生的总分排名次*/
				      break;		
			case 0:   break;
		}
	}while(choice);
...
int runMain(Medcine med[],int n,int choice)    /*主控模块，对应于一级菜单其下各功能选择执行*/
{
		switch(choice)
		{
			case 1: printHead( );           /* 1. 显示基本信息*/
		 			...
		 			break;
			case 2: baseManage(med,n);    /* 2. 记录管理*/
					break;	
			case 3: n=scoreManage(med,n);   /* 3. 药品进出库管理*/ 
			   	     break;
			case 4: countManage(med,n);     /* 4. 其他信息统计*/
					break;
